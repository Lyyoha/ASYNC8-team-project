import{a as p,C as P,i as M,A,S as y,N as h,P as v}from"./assets/vendor-96xp1dn3.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function r(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(a){if(a.ep)return;a.ep=!0;const n=r(a);fetch(a.href,n)}})();const s={body:document.body,burger:document.querySelector(".burger-container"),burgerBtn:document.querySelector(".burger-icon"),burgerBtnClose:document.querySelector(".btn-close"),burgerMenuLink:document.querySelector(".menu-link"),burgerMenuBtn:document.querySelector(".button-menu"),feedbackList:document.querySelector(".js-feedback-list"),burger:document.querySelector(".burger-container"),burgerBtn:document.querySelector(".burger-icon"),burgerBtnClose:document.querySelector(".btn-close"),burgerMenuLink:document.querySelectorAll(".burger-menu-link"),burgerMenuBtn:document.querySelector(".button-menu"),wrapper:document.querySelector(".about-us-list"),items:document.querySelectorAll(".about-us-item"),desertsList:document.querySelector(".desert-cards"),desertsCategories:document.querySelector(".desert-categories"),desertsCategoriesSelect:document.querySelector(".desert-categories-select"),desertsEmpty:document.querySelector(".desert-empty"),desertsLoadMore:document.querySelector(".desert-load-more"),popularList:document.querySelector(".swiper-wrapper")},H=()=>{s.burger.classList.add("is-open"),s.body.classList.add("scroll-lock")},L=()=>{s.burger.classList.remove("is-open"),s.body.classList.remove("scroll-lock")};p.defaults.baseURL="https://deserts-store.b.goit.study/api";const I=async()=>{const{data:e}=await p.get("/feedbacks?limit=10&page=1");return e.feedbacks};async function w({page:e=1,limit:t=9,category:r=null}={}){const o={page:e,limit:t};r&&(o.category=r);const{data:a}=await p.get("/desserts",{params:o});return a}async function x(){const{data:e}=await p.get("/categories");return e}const j=async()=>{const{data:e}=await p.get("/desserts",{params:{type:"popular"}});return e},d="/ASYNC8-team-project/assets/sprite-ByJCB0-d.svg",N=e=>{const t=Math.floor(e),r=e%1!==0;return`
...
</li>`,V={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};function u(e=""){return String(e).replace(/[&<>"']/g,t=>V[t])}function F({_id:e,name:t,description:r,price:o,image:a,category:n}){const c=u(t),T=u(r),B=u((n==null?void 0:n.name)??"");return`
  ...
  `}function D(e){return e.map(F).join("")}function z(e){const t='<li><button type="button" class="desert-chip is-active" data-id="">Всі десерти</button></li>',r=e.map(({_id:o,name:a})=>`<li><button type="button" class="desert-chip" data-id="${o}">${u(a)}</button></li>`).join("");return t+r}function R(e){const t='<option value="">Всі десерти</option>',r=e.map(({_id:o,name:a})=>`<option value="${o}">${u(a)}</option>`).join("");return t+r}function U(e=6){return`
